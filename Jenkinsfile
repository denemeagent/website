  ...
  stages {
    ...
    stage("Install docker"){
      steps{
        ...
        sudo wget https://download.docker.com/linux/ubuntu/dists/hirsute/pool/stable/amd64/docker-compose-plugin_2.3.3~ubuntu-hirsute_amd64.deb
        sudo wget https://download.docker.com/linux/ubuntu/dists/hirsute/pool/stable/amd64/docker-scan-plugin_0.17.0~ubuntu-hirsute_amd64.deb
        ls
        sudo docker version
        '''
      }
